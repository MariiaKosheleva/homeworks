...
class Util<V> implements Multiplier<Number> {
    ...
    public <T extends Number, E extends Number> void sum(T one, E two) { // should work only with numbers
...
interface Multiplier<V extends Number> {
